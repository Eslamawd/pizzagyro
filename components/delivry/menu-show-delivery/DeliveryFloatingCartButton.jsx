...
const DeliveryFloatingCartButton = ({ cartCount, cartTotal, onOpenCart }) => {
  ...
  return (
    <motion.div
      initial={{ y: 100 }}
      animate={{ y: 0 }}
      className="fixed bottom-6 left-4 right-4 z-[999] max-w-lg mx-auto"
    >
      <Button
        onClick={onOpenCart}
        className="w-full py-7 h-16 rounded-full bg-orange-500 z-[1000]
        hover:bg-orange-600 text-white shadow-[0_15px_40px_rgba(249,115,22,0.4)] flex justify-between px-6 transition-all"
      >
